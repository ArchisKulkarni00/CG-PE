...
// potree.loadPointCloud("metadata.json", baseUrl).then(pco => {
//   // Get bounding box from Potree cloud
//   const bbox = pco.boundingBox.clone();
...
//   // Wrap the cloud in a group
//   const group = new THREE.Group();
//   group.add(pco);

//   // Shift cloud so it’s centered
//   // group.position.sub(center);

//   // Scale it into a 100-unit cube
